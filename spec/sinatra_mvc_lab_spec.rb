describe "Pig Latinizer App" do
  ...
  describe "POST '/piglatinize'" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("eOncay uponay a imetay and a eryvay oodgay imetay itay asway erethay asway a oocowmay omingcay ownday alongay ethay oadray and isthay oocowmay atthay asway omingcay ownday alongay ethay oadray etmay a icenay ittlelay o
ybay amednay abybay uckootay")
    end
  end
